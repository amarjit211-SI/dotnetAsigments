...
//            Student studentobj = new Student(name,id,gender,age);


//            Console.WriteLine($"Student Name:{studentobj.Name}\n student Id:{studentobj.StudentId}\n Geneder:{studentobj.Gender}\n StudentAge:{studentobj.Age}");

//        }
//    }
//}
namespace cSharpAssigment2Prb1
{
    internal class Program
    {
        static void Main(string[] args)
